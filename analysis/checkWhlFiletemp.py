...
def check_whl_file(data):
    ...
    if gitH[0]:
        ...
        if not os.path.exists(os.path.join(directory,
                                           "/home/osolarin/ReproducibleTests/analysis/data/diffoscopeLogsTop/{}".format(
                                                   data["project"]))):
            os.system("mkdir /home/osolarin/ReproducibleTests/analysis/data/diffoscopeLogsTop/{}".format(data["project"]))
        ...
        try:
            ...
            if not os.path.exists(os.path.join(directory,
                                               "/home/osolarin/ReproducibleTests/analysis/data/diffoscopeLogsTop/{}/all.html".format(
                ...
                for variation in possible_variations:
                    kcode = os.system(
                        "reprotest --diffoscope-arg='--html=/home/osolarin/ReproducibleTests/analysis/data/diffoscopeLogsTop/{}/{}.html' --variations=-all,"
                        "{} 'pip wheel . --no-deps "
                        "--no-build-isolation --no-clean -w ./dist' 'dist/*.whl'"
                    ...
                    if not os.path.exists(
                            os.path.join(directory, "/home/osolarin/ReproducibleTests/analysis/data/diffoscopeLogsTop/"
...
if __name__ == '__main__':
    # pickRandom(49)
    records = json.loads(open('data/pypi_Top100.json', 'r').read())

    # parse records a s a list
    records = records['data']
    print(records)
    i = 0
    while len(json.loads(open('/home/osolarin/ReproducibleTests/analysis/data/recordsTestingPlainTop100.json', 'r').read())[
                  'results']) < 100:
        ...
        if rep[0]:
            record = json.loads(
                open('/home/osolarin/ReproducibleTests/analysis/data/recordsTestingPlainTop100.json', 'r').read())
            ...
            print(record)
            with open(os.path.join(os.path.dirname(__file__), 'data/recordsTestingPlainTop100.json'), 'w') as f:
